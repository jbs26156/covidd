...
public class ContactTraceRepoImpl implements ContactTraceRepo{
    ...
    public ContactTraceEntity findByBuilding(String building) {
        ...
        try (Connection connection = H2JDBCUtils.getConnection();
            ...
            while (rs.next()) {
                contactTraceEntityObject.setId( (long) rs.getInt("username"));
            ...
            if (contactTraceEntityObject.getEmail().equalsIgnoreCase("")) {
                ...
                String from = "COVID_Alerts_FA2020@gmail.com";
                String host = "smtp.gmail.com";
                Properties properties = System.getProperties();
                properties.put("mail.smtp.host", host);
                properties.put("mail.smtp.port", "465");
                properties.put("mail.smtp.ssl.enable", "true");
                properties.put("mail.smtp.auith", "true");
                String username = "COVID_Alerts_FA2020@gmail.com";

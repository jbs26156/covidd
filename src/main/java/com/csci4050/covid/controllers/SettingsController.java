...
public class SettingsController {
    ...
    @Autowired
    BuildingsRepository buildingsRepo;

    //TODO - implement design patterns
    public SettingsController(ContactTraceRepo contactTraceRepo, BuildingsRepository buildingsRepo) {
...
//        }
        ...
        if (flag) {
            ...
            System.out.println( "Building one is : " + contactTraceForm.getBuilding1() );
